        ...
        <div className="mx-auto max-w-7xl px-6">
          ...
          <div className="grid min-h-[320px] items-center gap-10 md:grid-cols-[1fr_auto_1fr] md:min-h-[420px]">
            ...
            <div className="flex flex-col items-start">
              ...
              <button className="mt-8 rounded-full bg-[#FF5A3D] px-10 py-4 text-base font-semibold text-white shadow-sm hover:opacity-95 active:opacity-90">
                Book A Demo
              </button>
            </div>
            ...
            <div className="flex flex-col items-center">
              ...
              <p className="mt-6 max-w-md text-center text-base font-semibold leading-6 text-zinc-700 md:text-lg">
